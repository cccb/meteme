    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(default=b'/static/store/img/product_default.png', upload_to=b'products/')),
        ...
        migrations.AddField(
            model_name='price',
            name='price_set',
            field=models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='store.PriceSet'),
        ),
        migrations.AddField(
            model_name='price',
            name='product',
