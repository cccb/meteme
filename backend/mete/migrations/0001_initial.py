# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-04-28 20:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default='/static/store/img/default_avatar.png', null=True, upload_to='avatars/')),
                ...
                ('balance', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency=b'EUR', max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('private_key', models.CharField(max_length=68, unique=True)),
                ('public_key', models.CharField(max_length=64, unique=True)),
                ('verify_key', models.CharField(max_length=64, unique=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
